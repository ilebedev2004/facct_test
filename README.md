...
Но можно выделить основные HTPP Post запросы.
1. -> "/loader/complete/"
2. -> "/dlls/"
3. -> "/cfg/"
4. -> "/log/"
...
Все украденные данные малварь сохраняет в sqlite базу данных по пути $(ALLUSERSPROFILE) и пытается отправить на CnC сервер.  

## Conclusion
Что бы замести следы , малварь удаляет все созданные файлы и использует след. комманду ```cmd.exe /c timeout /t 3  & del /f /q ...```
